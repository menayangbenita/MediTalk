    ...
    <div class="d-flex flex-column flex-column-fluid">
                                    ...
                                    @foreach ($laborats as $laborat)
                                        <tr>
                                            ...
                                            <td class="text-start pe-0">
                                                <span class="fw-bold">{{ $laborat->nama }}</span>
                                            </td>
                                            <td class="text-end pe-0">
                                                <span class="fw-bold">{{ $laborat->email }}</span>
                                            </td>
                                            <td class="text-end">
                                                <form action="{{ route('akunlaborat.hapus', $laborat->id) }}" method="POST"
                ...
                <div class="modal-content rounded">
                    ...
                    <div class="modal-body">
                        <form novalidate="novalidate" id="kt_tambah_dokter" autocomplete="off"
                            data-url-edit="{{ route('akunlaborat.edit') }}"
                            data-kt-redirect-url="{{ route('akunlaborat') }}" action="{{ route('akunlaborat') }}"
                            method="post">
                            @csrf()
        ...
        {{-- <script>
            ...
            function resetForm() {
                ...
                document.getElementById("kt_tambah_dokter").action = "/akunlaborat";
            }
