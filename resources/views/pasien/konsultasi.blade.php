            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="row g-6 g-xl-9">
                    @foreach ($dokters as $dokter)
                        <div class="col-md-6 col-xxl-3 doctor-card" data-poli="{{ $dokter->spesialis }}">
                            <div class="card">
                                <div class="card-body d-flex flex-center flex-column p-9">
                                    ...
                                    <a href="{{ route('profildokter', ['id' => $dokter->id]) }}"
                                        class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">{{ $dokter->nama }}</a>
                                    <div class="fw-semibold text-gray-400 mb-6">Dokter Spesialis {{ $dokter->spesialis }}
                                    </div>
