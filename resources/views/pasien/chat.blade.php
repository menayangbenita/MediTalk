                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="./konsultasi_profil_dokter.html" class="text-muted text-hover-primary">Profil
                                    Dokter</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="card" id="kt_chat_messenger">
                            ...
                            <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                                <form action="{{ route('chat.send') }}" method="post" id="sendMessageForm">
                                    @csrf
                                    <input type="hidden" name="konsultasi_id" value="{{ $konsultasis->id }}">
                                    <input type="hidden" name="sender_id" value="{{ Auth::user()->id }}">
                                    <input type="hidden" name="receiver_id" value="{{ $konsultasis->dokter->id }}">
                                    <input type="hidden" id="incoming_id" value="{{ $konsultasis->dokter->id }}">
                                    <textarea class="form-control mb-3" rows="1" data-kt-element="input" placeholder="Ketik pesan..."
                                        name="message" id="messageInput"></textarea>
