                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="./konsultasi.html" class="text-muted text-hover-primary">Konsultasi dengan
                                    Dokter</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap">
                            <div class="me-7 mb-4">
                                <div class="symbol symbol-150px symbol-lg-175px symbol-fixed position-relative">
                                    <img src="{{ asset('storage/' . $dokter->foto) }}" alt="image" />
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="#"
                                                class="text-gray-900 text-hover-primary fs-1 fw-bold">{{ $dokter->nama }}</a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="mb-5">
                                                <div class="d-flex align-items-center">
                                                    <div class="fs-2 fw-bold">
                                                        {{ 'Rp ' . number_format($dokter->tarif, 0, ',', '.') }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-sm-center mb-8">
                                    ...
                                    <div class="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0">
                                        <div class="flex-grow-1 my-lg-0 my-2 me-2">
                                            ...
                                            <span class="text-muted fw-semibold d-block pt-1">{{ $dokter->alumnus }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex align-items-sm-center mb-8">
                                    ...
                                    <div class="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0">
                                        <div class="flex-grow-1 my-lg-0 my-2 me-2">
                                            ...
                                            <span
                                                class="text-muted fw-semibold d-block pt-1">{{ $dokter->tempat_praktik }}</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0">
                                        <div class="flex-grow-1 my-lg-0 my-2 me-2">
                                            <div class="text-gray-800 fw-bold fs-6">STR (Surat Tanda
                                                Registrasi)</div>
                                            <span class="text-muted fw-semibold d-block pt-1">{{ $dokter->str }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body pt-8">
                                ...
                                <div class="d-flex align-items-sm-center my-7">
                                    <div class="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="fw-bolder">
                                                {{ 'Rp ' . number_format($dokter->tarif + 2000, 0, ',', '.') }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
