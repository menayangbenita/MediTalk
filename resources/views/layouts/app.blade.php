                        ...
                        <div class="">
                            <div class="d-flex align-items-center"
                                ...
                                <div class="d-flex flex-column align-items-start justify-content-center ms-3">
                                    ...
                                    <a href="#" class="text-gray-800 fs-7 fw-bold text-hover-primary">{{ Auth::user()->nama }}</a>
                                </div>
                            </div>
