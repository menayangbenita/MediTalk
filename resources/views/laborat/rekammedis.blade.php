                                ...
                                <tbody class="fw-semibold text-gray-600 text-start">
                                    @foreach ($rekammedis as $rekam)
                                        <tr>
                                            ...
                                            <td class="fw-bold">
                                                <div class="text-primary fs-5 fw-bold" data-kt-dokter-filter="{{ $rekam->pasien->nama }}">
                                                    {{ $rekam->pasien->nama }}</div>
                                                <div class="text-muted fs-7 fw-bold">No. RM: {{ $rekam->pasien->rekammedis }}</div>
                                            </td>
                                            <td>{{ $rekam->tanggal }}</td>
                                            <td class="d-flex justify-content-end">
                                                ...
                                                <form action="{{ route('rekammedis.hapus', $rekam->id) }}" method="POST"
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body">
                    <form novalidate="novalidate" id="kt_tambah_dokter" autocomplete="off"
                        data-kt-redirect-url="{{ route('rekammedis') }}" action="{{ route('rekammedis.store') }}"
                        method="post">
                        @csrf
                        ...
                        <div class="row mb-8">
                            <div class="col-lg-4">
                                ...
                                <!--end::Label-->
                                <input class="form-control form-control-solid" type="date" name="tanggal" id="tanggal">
                            </div>
                            <div class="col-lg-4">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                ...
                                <select class="form-select form-select-solid fw-bold" data-kt-select2="true"
                                    ...
                                    id="pasien_id" data-dropdown-parent="#kt-toolbar-filter">
                                    <option value=""></option>
                            ...
                            <div class="col-lg-4">
                                ...
                                <select class="form-select form-select-solid fw-bold" data-kt-select2="true"
                                    ...
                                    id="dokter_id" data-dropdown-parent="#kt-toolbar-filter">
                                    <option value=""></option>
