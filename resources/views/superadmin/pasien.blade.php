                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                                <thead>
                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-end min-w-100px">Nomor Rekam Medis</th>
                                    ...
                                    @foreach ($pasiens as $pasien)
                                        <tr>
                                            ...
                                            <td class="text-end pe-0">
                                                <span class="fw-bold">{{ $pasien->rekammedis }}</span>
                                            </td>
                                            <td class="text-end pe-0">
                                                <span class="fw-bold">{{ $pasien->email }}</span>
                                            </td>
                                            <td class="text-end">
                                                <form action="{{ route('akunpasien.hapus', $pasien->id) }}" method="POST"
                                                    onsubmit="return confirm('Yakin ingin menghapus pasien ini?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-icon-danger pe-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a data-id="{{ $pasien->id }}" data-nama="{{ $pasien->nama }}"
                                                            data-email="{{ $pasien->email }}"
                                                            data-password="{{ $pasien->password }}" data-bs-toggle="modal"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable mw-850px">
                <div class="modal-content rounded">
                    <div class="modal-header">
                        <h3 class="modal-title" id="dokterModalLabel">Tambah Pasien</h3>
                    ...
                    <div class="modal-body">
                        <form novalidate="novalidate" id="kt_tambah_dokter" autocomplete="off"
                            data-url-edit="{{ route('akunpasien.edit') }}"
                            data-kt-redirect-url="{{ route('akunpasien') }}" action="{{ route('akunpasien') }}"
                            method="post">
                            @csrf()
                            ...
                            <div class="row mb-8">
                                ...
                                <div class="col-lg-6">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                        <span class="required">Nomor Rekam Medis Pasien</span>
                                    </label>
                                    <!--end::Label-->
                                    <input type="text" class="form-control form-control-solid" name="rekammedis"
                                        id="rekammedis" placeholder="Cth: NR3388347" />
                                </div>
